...
Scapy
📦 Installation
Clone the repository: git clone https://github.com/yourusername/packet-sniffer.git

Navigate into the folder: cd packet-sniffer
...
📁 Project Structure
packet-sniffer/ │── packet_sniffer.py │── README.md │── requirements.txt
